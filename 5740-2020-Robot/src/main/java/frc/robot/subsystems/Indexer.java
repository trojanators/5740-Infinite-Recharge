...
public class Indexer extends SubsystemBase {
  ...
  enum IndexerState {
    INIT, CELL_IN_INPUT_QUEUE, CELL_LOADED, SHOOTING, CELL_IN_OUTPUT_VIEW_SHOOTING, CELL_IN_OUTPUT_VIEW,
    SHOOTING_INTERRUPTED, CELLS_UNLOADED, FULL, NOT_FULL, ERROR
  }
  ...
  public void runIndexer() {
    if (DriverStation.getInstance().isEnabled()) {
      ...
      if (inputDistance <= Constants.kCellIncomingValueHigh && inputDistance >= Constants.kCellIncomingValueLow
          && currentState != IndexerState.SHOOTING_INTERRUPTED) {
      ...
      if (outputDistance <= Constants.kCellOutgoingValueHigh && outputDistance >= Constants.kCellIncomingValueLow
          && currentState == IndexerState.SHOOTING) {
