...
public final class Constants {
    ...
    public static double kIndexerStowingMotorPower = .5;
    public static double kIndexerShootingMotorPower = .5;
    public static final int kmanualIndexerREVButton = 7;
	public static final int kmanualIndexerFWDButton = 6;
